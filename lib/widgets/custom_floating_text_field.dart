...
class CustomFloatingTextField extends StatelessWidget {
  CustomFloatingTextField(
      ...
      this.filled = false,
      this.validator,
      this.onChanged, // New event callback for text changes
      this.onEditingComplete}) // New event callback for editing complete
      : super(
          key: key,
        );
  ...
  Widget floatingTextFieldWidget(BuildContext context) => Container(
        ...
        child: TextFormField(
          ...
          validator: validator,
          onChanged: onChanged, // Exposing text change event
          onEditingComplete:
              onEditingComplete, // Exposing editing complete event
        ),
      );
  ...
  InputDecoration get decoration => InputDecoration(
        ...
        isDense: true,
        contentPadding:
            contentPadding ?? EdgeInsets.fromLTRB(8.h, 24.h, 8.h, 8.h),
        fillColor: fillColor,
        filled: filled,
