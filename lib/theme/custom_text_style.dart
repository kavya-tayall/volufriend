...
class CustomTextStyles {
  ...
  static final TextStyle titleMedium = TextStyle(
    ...
    letterSpacing: 0.5, // Set letter spacing if needed
  );
...
// Headline text style
  ...
  static get headlineSmallRobotoGreenA100 =>
      theme.textTheme.headlineSmall!.roboto.copyWith(
...
// Title text style
  ...
  static get titleMediumGreenA100 => theme.textTheme.titleMedium!.copyWith(
        color: appTheme.greenA100,
        fontWeight: FontWeight.w500,
      );
  ...
  static get titleSmallGreenA100 => theme.textTheme.titleSmall!.copyWith(
        color: appTheme.greenA100,
      );
