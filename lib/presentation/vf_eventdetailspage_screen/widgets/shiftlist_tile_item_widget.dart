...
// ShiftlistTileItemWidget widget definition
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            _buildDetailRow(context, Icons.access_time,
                'Start Time: ${shift.startTime ?? "Not Available"}'),
            const SizedBox(height: 4),
            _buildDetailRow(context, Icons.access_time,
                'End Time: ${shift.endTime ?? "Not Available"}'),
            const SizedBox(height: 4),
            _buildDetailRow(context, Icons.person,
                'Min Age: ${shift.minAge ?? "No age limit"}'),
            const SizedBox(height: 4),
            _buildDetailRow(context, Icons.people,
